    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Chairs', 'Chairs'), ('Beds', 'Beds'), ('Accessories', 'Accessories'), ('Furniture', 'Furniture'), ('Home Deco', 'Home Deco'), ('Dressings', 'Dressings'), ('Table', 'Table')], max_length=20)),
